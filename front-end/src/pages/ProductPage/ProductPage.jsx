    ...
    <div className="pt-[100px] pb-[100px] px-[20px] relative">
      <div className="flex flex-row justify-center items-center">
        <div className="flex flex-col justify-center items-center gap-[12px] lg:gap-[24px] lg:flex-row lg:items-start end:w-[1500px]">
          <div className={`flex flex-col justify-center end:justify-between items-center lg:items-start gap-[8px] end:gap-[0px] sm2:flex-row-reverse transition-all duration-[0.5s]`}>
            <img
              src={product.image}
          ...
          <div className={`flex flex-col justify-start items-start lg:items-start gap-[4px] md:justify-center md:items-center lg2:w-[800px] transition-all duration-[0.5s]`}>
